...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Login Premium Cars Rental</title>
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="" alt=""><h1>Premium Cars</h1><h5>Vendor Panel</h5>
                    </div>
                </div>
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login with Premium Cars</span></h6>
            </div>
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    <form class="form-horizontal form-simple" id="send_details">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" 
                            name="user-name" placeholder="Your Username" required>
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block" onclick="company_login();">
...
<script>
  function company_login()
  {
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('')?>Login/CheckUserDetail',
