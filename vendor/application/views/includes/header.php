...
<!-- alertify css -->
<link href="<?php echo base_url('assets/alertify/css/alertify.css');?>" rel='stylesheet' type='text/css' /><link href="<?php echo base_url('assets/alertify/css/alertify.min.css');?>" rel='stylesheet' type='text/css' />
        ...
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="<?php echo base_url();?>/Home" class="navbar-brand nav-link">
              ...
              <small style="color: white; font-size: 15px;float: right;"><?php echo $this->session->userdata('vendor_name'); ?></small>
            </a></li>
