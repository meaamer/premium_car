                      ...
                      <div class="modal-body">
                        <form class="form" id="form_data">
                          ...
                          <div class="row">
                            ...
                            <input type="text" class="form-control round"
                             placeholder="Other Charges" name="other_charges" id="other_charges">
                            </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <input type="text"  class="form-control round" placeholder="Advance Amount"
                             name="advance" id="advance" onkeyup="TotalAmount(<?=$pricings['transfer_rate'] ?>)">
                            </div>
                            </div>
                          ...
                          <input type="hidden" name="vendor_id" value="<?php echo $details['vendor_id']; ?>">
                            ...
                            <input type="text"  class="form-control round total_amount" 
                            placeholder="Total Amount" name="" disabled="">
...
<div class="col-lg-4 col-md-6 col-sm-12">
 ...
 <script type="text/javascript">
  ...
  //show to vendor recivable amount
     function TotalAmount(transfer_rate){
        ...
        var result = parseInt( $(".total_km").val()) * transfer_rate;
        var addAmount = parseInt(result) + parseInt(other_charges);
