          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr id="reload<?php echo $transfer['vendor_transfer_id'];?>">
                  <td><?php echo $i; ?></td>
                  <td><?php echo $transfer['vendor_name']; ?></td>
                  ...
                  <td>
                  	<a href="<?php echo base_url('VendorPricing/TRList/').$transfer['vendor_transfer_id'];?>" class="btn btn-danger"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
                  	<button type="button" class="btn btn-danger" 
                  	onclick="delete_TR(<?php echo $transfer['vendor_transfer_id'];?>);">
