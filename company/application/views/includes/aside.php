    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-bar-graph-2"></i><span data-i18n="nav.dash.main" class="menu-title">Booking Details</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a href="<?php echo base_url();?>ExcelReport"><i class="fa fa-bug" aria-hidden="true"></i><span data-i18n="nav.dash.main" class="menu-title">Reports</span></a></li>
