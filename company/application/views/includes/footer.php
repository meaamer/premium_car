    ...
    <footer class="footer footer-static footer-light navbar-border">
      ...
      <a href="https://pixinvent.com" target="_blank" class="text-bold-800 grey darken-2">PREMIUM CARS RENTAL </a>, All rights reserved. </span>
      <span class="float-md-right d-xs-block d-md-inline-block">Developed By <b> 
      <a href="http://www.dualsysch.com" class="text-bold-800 grey darken-2">DUALSYSCO</a> </b></span></p>
    </footer>
...
<!--Jqeury ui date time Picker-->
 ...
 <script src="//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/js/jquery.geocomplete.min.js" type="text/javascript"></script>
