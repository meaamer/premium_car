				...
				<div class="card-block">
					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								<th class="text-nowrap" scope="row">From City</th>
								<td colspan=""><?php echo $rows['from_city'];?></td>
							</tr>
							<tr>
								<th class="text-nowrap" scope="row">To City</th>
								<td colspan=""><?php echo $rows['to_city'];?></td>
							</tr>
							<tr>
							...
							<tr>
								<th class="text-nowrap" scope="row">No of Days</th>
								<td colspan=""><?php echo $rows['no_of_days'];?></td>
							</tr>
