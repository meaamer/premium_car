					...
					<div class="card-block">
						...
						<form class="form" id="booking">
								...
								<div class="col-md-4">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select name="duration" id="duration" class="form-control border-primary">
											<option value="" selected="" disabled="">Select </option>
												<option value="fullday">8 Hourse 80 KM </option>
												<option value="halfday">4 Hourse 40 KM  </option>
							...
							<div class="form-actions right">
								...
								<button type="button" id="continue" 	 class="btn btn-primary" onclick="ShowDetails();">
		...
		<div class="col-md-10">
			<div id="estimate_card" style="display:none;" class="card">
				...
				<div class="card-body collapse in">
					...
					<div id="error2" style="width:40%;"></div>
...
function ShowDetails(){
		...
		$.ajax({
      		type:"POST",
     		url:"<?php echo base_url()?>Booking/GetLocalEstimation",
     		data:form.serialize(),
      		//data:form.serialize(),
      		beforeSend: function(){
...
function add_booking()
  {
    ...
    $.ajax({
      type:"POST",
      url:"<?php echo base_url()?>Booking/LocalBooking",
      data:form.serialize(),
      beforeSend: function(){
